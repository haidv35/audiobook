        ...
        <table class="table">
            ...
            <tr>
                ...
                @php
                    $check = 0;
                @endphp
                @foreach ($paid_product_count as $key => $item)
                    @if($key == $product->id)
                        @php
                            $check = 1;
                        @endphp
                ...
                <td class="align-middle">
                    <label class="switcher-control">
                        <input type="checkbox" class="switcher-input new_product" name='new_product[]' value="{{ $product->id }}" @if($product->new_product == 1) checked @endif> <span class="switcher-indicator"></span>
                    </label>
                </td>
                <td class="align-middle">
                    <label class="switcher-control">
                        <input type="checkbox" class="switcher-input hot_product" name='hot_product[]' value="{{ $product->id }}" @if($product->hot_product == 1) checked @endif> <span class="switcher-indicator"></span>
                    </label>
                </td>
                <td class="align-middle text-right">
                    <a href="{{ route('admin.product.edit',$product->id) }}" class="btn btn-sm btn-icon btn-secondary">
...
<script>
    let product_status = "{{ route('admin.product.status') }}";
</script>
<script src="/js/admin/product/home.js"></script>
@endsection
