      ...
      <div class="top-bar-list">
        ...
        <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
            ...
            <li class="nav-item dropdown header-nav-dropdown has-notified">
              ...
              <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                ...
                <div class="dropdown-scroll perfect-scrollbar">
                  ...
                  <a href="#" class="dropdown-item unread">
                    <div class="user-avatar">
                      <img src="/looper/assets/images/avatars/team1.jpg">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="/looper/assets/images/avatars/team3.png">
                    </div>
                    <div class="dropdown-item-body">
                  ...
                  <a href="#" class="dropdown-item">
                    <div class="user-avatar">
                      <img src="/looper/assets/images/avatars/team2.png">
                    </div>
                    <div class="dropdown-item-body">
          ...
          <div class="dropdown d-flex">
            <button class="btn-account d-none d-md-flex" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="user-avatar user-avatar-md"><img src="/looper/assets/images/avatars/unknown-profile.jpg" alt=""></span> <span class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">{{ Auth::user()->name }}</span> <span class="account-description">{{ Auth::user()->username }}</span></span></button> <!-- .dropdown-menu -->
            <div class="dropdown-menu">
              <div class="dropdown-arrow ml-3"></div>
              <h6 class="dropdown-header d-none d-md-block d-lg-none"> {{ Auth::user()->username }} </h6><a class="dropdown-item" href="/user/profile"><span class="dropdown-icon oi oi-person"></span> Chỉnh sửa thông tin</a> <a class="dropdown-item" href="/admin/logout"><span class="dropdown-icon oi oi-account-logout"></span> Thoát</a>
